...
//         payable(bob).transfer(1e18);
//         payable(alice).transfer(4e22);
//     }
//     event Test1(uint256 value);
...
//         assertEq(ticketNFT.maxNumberOfTickets(), 3);
...
//         vm.startPrank(bob);
//         purchaseToken.mint{value: 1e18}();
//         assertEq(purchaseToken.balanceOf(bob), 100e18);
//         purchaseToken.approve(address(primaryMarket), 100e18);
//         uint256 id2 = primaryMarket.purchase(address(ticketNFT), "Bob");
//         uint256 id3 = primaryMarket.purchase(address(ticketNFT), "Bob");
...
//         assertEq(purchaseToken.balanceOf(charlie), ticketPrice+ ticketPrice+ticketPrice);
...
//         assertEq(secondaryMarket.getHighestBidder(address(ticketNFT), id), bob);
        ...
        // assertEq(purchaseToken.balanceOf(charlie), ticketPrice + ticketPrice + ticketPrice + fee);
        // assertEq(
